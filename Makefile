...
#$(BUILD)%.o: $(SOURCE)%.c
#	$(ARMGNU)-gcc -MD -O2 -Wall -nostdlib -nostartfiles -ffreestanding -marm -mcpu=arm1176jzf-s -c $(SOURCE) -I $(INCLUDE) $< -o $@


$(BUILD)%.o: $(SOURCE)%.c
	$(ARMGNU)-gcc -MMD -O2 -Wall -nostdlib -nostartfiles -ffreestanding -marm -mcpu=arm1176jzf-s -c  -I $(INCLUDE) $< -o $@
